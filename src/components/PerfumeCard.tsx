...
export function PerfumeCard({ product }: PerfumeCardProps) {
  ...
  return (
    <Card className="group overflow-hidden transition-all duration-300 hover:shadow-lg w-full min-w-[240px] flex flex-col h-full">
        ...
        {availableVariants.length > 0 ? (
          <>
            ...
            <div className="flex flex-col md:hidden gap-3 w-full">
              ...
              <div className="flex items-center justify-center bg-gray-50 rounded-lg p-2 w-full">
