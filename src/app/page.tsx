    ...
    <div className="min-h-screen">
      ...
      <section className="">
        <div className="px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-2 sm:gap-3 md:gap-4 px-4 sm:px-8 md:px-12 lg:px-16 xl:px-20" style={{ gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))' }}>
