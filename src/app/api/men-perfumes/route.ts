...
export async function POST(request: NextRequest) {
  try {
    ...
    return NextResponse.json({
      success: true,
      perfume: data,
      message: 'Men\'s perfume added successfully'
    });
...
export async function PUT(request: NextRequest) {
  try {
    ...
    return NextResponse.json({
      success: true,
      perfume: data,
      message: 'Men\'s perfume updated successfully'
    });
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    return NextResponse.json({
      success: true,
      message: 'Men\'s perfume deleted successfully'
    });
